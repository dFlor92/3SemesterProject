...
namespace WebClient.CampaignService {
    ...
    public interface ICampaignService {
        ...
        WebClient.CampaignService.Campaign[] All();
        
        [System.ServiceModel.OperationContractAttribute(Action="http://tempuri.org/ICampaignService/All", ReplyAction="http://tempuri.org/ICampaignService/AllResponse")]
        System.Threading.Tasks.Task<WebClient.CampaignService.Campaign[]> AllAsync();
        ...
        void Create(WebClient.CampaignService.Campaign entity);
        
        [System.ServiceModel.OperationContractAttribute(Action="http://tempuri.org/ICampaignService/Create", ReplyAction="http://tempuri.org/ICampaignService/CreateResponse")]
        System.Threading.Tasks.Task CreateAsync(WebClient.CampaignService.Campaign entity);
        ...
        WebClient.CampaignService.Campaign Read(int id);
        
        [System.ServiceModel.OperationContractAttribute(Action="http://tempuri.org/ICampaignService/Read", ReplyAction="http://tempuri.org/ICampaignService/ReadResponse")]
        System.Threading.Tasks.Task<WebClient.CampaignService.Campaign> ReadAsync(int id);
        ...
        void Update(WebClient.CampaignService.Campaign entity);
        
        [System.ServiceModel.OperationContractAttribute(Action="http://tempuri.org/ICampaignService/Update", ReplyAction="http://tempuri.org/ICampaignService/UpdateResponse")]
        System.Threading.Tasks.Task UpdateAsync(WebClient.CampaignService.Campaign entity);
    ...
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.ServiceModel", "4.0.0.0")]
    public interface ICampaignServiceChannel : WebClient.CampaignService.ICampaignService, System.ServiceModel.IClientChannel {
    }
    
    [System.Diagnostics.DebuggerStepThroughAttribute()]
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.ServiceModel", "4.0.0.0")]
    public partial class CampaignServiceClient : System.ServiceModel.ClientBase<WebClient.CampaignService.ICampaignService>, WebClient.CampaignService.ICampaignService {
        ...
        public WebClient.CampaignService.Campaign[] All() {
            return base.Channel.All();
        }
        
        public System.Threading.Tasks.Task<WebClient.CampaignService.Campaign[]> AllAsync() {
            return base.Channel.AllAsync();
        }
        
        public void Create(WebClient.CampaignService.Campaign entity) {
            base.Channel.Create(entity);
        }
        
        public System.Threading.Tasks.Task CreateAsync(WebClient.CampaignService.Campaign entity) {
            return base.Channel.CreateAsync(entity);
        }
        
        public WebClient.CampaignService.Campaign Read(int id) {
            return base.Channel.Read(id);
        }
        
        public System.Threading.Tasks.Task<WebClient.CampaignService.Campaign> ReadAsync(int id) {
            return base.Channel.ReadAsync(id);
        }
        
        public void Update(WebClient.CampaignService.Campaign entity) {
            base.Channel.Update(entity);
        }
        
        public System.Threading.Tasks.Task UpdateAsync(WebClient.CampaignService.Campaign entity) {
